//const danhsachdiem = new Map();

//danhsachdiem.set("Tan", 10);
//danhsachdiem.set("Lan", 9);
//danhsachdiem.set("Hieu", 8);
//danhsachdiem.set("Quang", 6);

//for (let [ten, diem] of danhsachdiem) {
//  console.log(`${ten}: ${diem} điểm`);
//}
//const điểm = new Map([
//  ["Tân", { toán: 10, văn: 6 }]
//]);
//for (let [tên, môn] of điểm) {
